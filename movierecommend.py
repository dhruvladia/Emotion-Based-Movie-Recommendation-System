...
print("MOVIES WILL BE SUGGESTED BASED ON THE EMOTION DETECTED")
...
#        10:130, c] * (1.0 - emoji_face[:, :, 3] / 255.0)
    ...
    if cv2.waitKey(1) & 0xFF == ord('s'):
        ...
        def main(emotion):
            ...
            if(em == "sad"):
                print('GENRE ALLOCATED IS DRAMA')
                print("Emotion: sad")
                urlhere = 'http://www.imdb.com/search/title?genres=drama&title_type=feature&sort=moviemeter, asc'
                print("Visit this imdb url to get your drama movie recommendations: " + urlhere)
                

            # IMDb Url for Musical genre of 
            # movie against emotion Disgust 
            elif(em == "disgust"):
                print('GENRE ALLOCATED IS MUSICAL')
                print("Emotion: disgust")
                urlhere = 'http://www.imdb.com/search/title?genres=musical&title_type=feature&sort=moviemeter, asc'
                print("Visit this imdb url to get your musical movie recommendations: " + urlhere)

            # IMDb Url for Family genre of 
            # movie against emotion Anger 
            elif(em == "angry"):
                print('GENRE ALLOCATED IS FAMILY')
                print("Emotion: Angry")
                urlhere = 'http://www.imdb.com/search/title?genres=family&title_type=feature&sort=moviemeter, asc'
                print("Visit this imdb url to get your family movie recommendations: " + urlhere)

            # IMDb Url for Thriller genre of 
            # movie against emotion Anticipation 
            elif(em == "neutral"):
                print('GENRE ALLOCATED IS THRILLER')
                
                urlhere = 'http://www.imdb.com/search/title?genres=thriller&title_type=feature&sort=moviemeter, asc'
                print("Emotion: Neutral")
                print("Visit this imdb url to get your thriller movie recommendations: " + urlhere)

            # IMDb Url for Sport genre of 
            # movie against emotion Fear 
            elif(em == "scared"):
                print('GENRE ALLOCATED IS SPORTS')
                print("Emotion: scared")
                urlhere = 'http://www.imdb.com/search/title?genres=sport&title_type=feature&sort=moviemeter, asc'
                print("Visit this imdb url to get your sports movie recommendations: " + urlhere)
            ...
            # movie against emotion Surprise 
                ...
                print("Visit this imdb url to get your film noir movie recommendations: " + urlhere)
